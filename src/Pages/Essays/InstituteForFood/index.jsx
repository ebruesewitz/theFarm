...
const InstituteForFoodWithClasses = ({
  classes
    ...
    >
      <img src={InstituteforFood} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={LoadedTruck} alt="" className={[classes.image, classes.figure].join(" ")}/>
      <img src={CSABoxNov} alt="" className={[classes.image, classes.figure].join(" ")}/>
      <img src={CarrotsPeppers} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={ConstructingHoopHouse} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={lettucerows} alt="" className={[classes.image, classes.figure].join(" ")}/>
      <img src={Harvest} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={carrotsinsoil} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={StudentSalsaSale} alt="" className={[classes.image, classes.figure].join(" ")}/>
      <img src={ChineseCabbage} alt="" className={[classes.image, classes.figure].join(" ")}/>
      <img src={CSABoxNov} alt="" className={[classes.image, classes.figure].join(" ")}/>
      ...
      <img src={IFinterns} alt="" className={[classes.image, classes.figure].join(" ")}/>
    </ EssayPage>
  );
