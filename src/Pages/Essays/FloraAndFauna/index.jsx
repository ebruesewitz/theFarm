  ...
  classes
    ...
    >
      ...
      <div className={classes.figure}>
        <img src={Forestsfigure1} className={classes.image} alt="geographical distribution and representative climate conditions for the temperate deciduous forests of Eastern North America"/>
      </div>
      <div className={classes.figure}>
        <img src={Forestsfigure2} className={classes.image} alt="profile images showing the ecological structure of old-regrowth forest in an upland setting in the Miami University Natural Areas"/>
      </div>
      ...
      <div className={classes.figure}>
        <img src={Forestsfigure3} className={classes.image} alt="regional maps of forest types in eastern North America"/>
      </div>
      <div className={classes.figure}>
        <img src={Forestsfigure4} className={classes.image} alt="forest loss and regrowth in the eastern Corn Belt"/>
      </div>
      ...
      <div className={classes.figure}>
        <img src={Forestsfigure5} className={classes.image} alt="forest diversity patterns near the MU Institute for Food farm"/>
      </div>
