...
const AustinMagieFarmWithClasses = ({
  classes
    ...
    >
      ...
      <p className={classes.pullQuote2}>" The large hall, and winding staircase with landing, made its beauty complete, and gave one the feeling, that the person who designed it so long ago, really knew what living meant "</p>
      <div className={classes.figureContainer}>
        <figure
          className={[classes.figure, classes.figureOverride].join(" ")}
        >
