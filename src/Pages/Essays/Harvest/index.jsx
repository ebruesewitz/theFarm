...
const HarvestWithClasses = ({
  classes
    ...
    >
      ...
      <p>A basic notion of sustainable food production is the amount of energy input it takes to produce our food. Using modern farming techniques, it takes about 30 calories to produce one calorie of food. In subsistence agriculture one calorie of labor can produce 5 to 10 calories of food energy. Currently, about 1/6 of the energy used in our food system is for refrigeration and transport, the so-called food-miles measure. Locally grown food can reduce the ‘carbon-cost’ of certain foods that we eat. Other sustainable practices like cover crops and reduced tillage also help improve the environmental impact of producing food.</p>
      <figure
        className={classes.figure}
      >
      ...
      <p>We can also make the distinction between real food and processed food. Just following the USDA guidelines for nutritional health, that is, 5-7 servings of fresh fruits and vegetables daily, would require a major change in most people’s diets, specifically, away from processed (fast) food to a plant-based (slow food) diet. CSA’s offer the opportunity for families and individuals to make that change. This does require us to become more involved with our food, like making meals and sharing food, engaging in the activities that form the foundation of human culture.  This is definitely part of the community in Community Supported Agriculture.</p>
      <p>What does all this mean for a local food farmer? To be economically viable, the CSA farmer must produce from early Spring to late Fall to get the most from his available resources. Here in Ohio we have 3 growing seasons, spring summer, and fall.  This means we have two cool weather seasons and one warm season, that is 6 months of cool season crops (leafy vegetables and roots) and, hopefully, 4 months of summer crops (beans, corn, melons, tomatoes, peppers, and others). Humans in temperate climates ate these crops seasonally for thousands of years, until refrigeration and global transport began less than 150 years ago.  Are there benefits from eating seasonally? Try it and see if you can feel the difference. </p>
